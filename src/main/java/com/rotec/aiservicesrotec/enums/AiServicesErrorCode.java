package com.rotec.aiservicesrotec.enums;


import com.rotec.aiservicesrotec.exception.AiServicesException;

public enum AiServicesErrorCode {
    ...
    AiServicesErrorCode(int code, String message) {
        this.code = code;
    ...
    public AiServicesException toException() {
        return new AiServicesException(this.code, this.message);
    }

    public AiServicesException toException(String detail) {
        return new AiServicesException(this.code, this.message + (detail != null ? ": " + detail : ""));
    }

    public AiServicesException toException(Throwable cause) {
        return new AiServicesException(this.code, this.message, cause);
    }
